  ...
  <main>
    <section class="sec">
      <div class="d-flex">
        ...
        <div
          class="w-25 bar d-flex justify-content-center align-items-center"
          id="b1"
        >
        ...
        <div class="w-75" id="s2">
          ...
          <transition name="slide_2">
            <div v-show="isShow_s2">
              <div
                style="display: flex; justify-content: left; margin-left: 6vw"
              >
                <div class="feature">
                  <svg
                    version="1.1"
          ...
          <transition name="slide_3">
            ...
            >
              <div class="profile">
                ...
                <a
                  href="https://kotno557.github.io/Internet-fall-2022/"
                  target="_blank"
                >
              ...
              <div class="profile">
                <img
                  src="https://internet.nizw0.com/static/media/profile.27bb6496e46aef6d68c9.png"
                />
