    ...
    <div id="page">
        ...
        <div id="middle">
            <div id="sheet">
                ...
                <think v-else-if="events[view_poll].category === 2" :roomTopic="events[view_poll].name" :id="events[view_poll].id" />
                <lotto v-else-if="events[view_poll].category === 3" :roomTopic="events[view_poll].name" :id="events[view_poll].id" />
