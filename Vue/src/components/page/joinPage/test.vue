        ...
        <div class="myfont" style="jusfy-content: center;">
            ...
            <div class="mt-3 mb-3 overflow-auto" v-bind="questionPointer">
                ...
                <div style="justify-content: center; display: flex;" class="mt-5 mb-5">  
                    <ul class="list-group myfont" v-for="i in question[questionPointer-1].choice">
                        <li class="list-group-item">
                            <input v-if="question[questionPointer-1].is_multiple==false" class="form-check-input me-4" type="radio" name="exampleRadios" id="exampleRadios1" value="option1"> 
