  ...
  <div id="page">
    ...
    <div id="middle">
      <div id="sheet">
        ...
        >
          <ul
            class="list-group myfont gray-hover"
            style="width: 98%; font-size: 3vmin"
          >
            <a
              class="list-group-item"
              v-for="item in this.room"
              :href="`/dashboard/${this.userId}/${item.id}`"
            >
              <span class="material-symbols-outlined"> event </span>
              {{ item.name }}
              <small style="color: rgb(102, 98, 98, 0.5); font-size: medium"
                >#{{ item.id }}</small
              >
            </a>
          </ul>
