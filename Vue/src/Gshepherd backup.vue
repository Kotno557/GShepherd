...
window.addEventListener("mousewheel", function (event) {
  ...
  if (Date.now() - lastRoll > 300) {
    ...
    for (let i = 0; i < s.length; i++) {
      if (s[i].classList.contains("show")) now = i;
    }
  ...
  <div id="wapper">
    ...
    <div id="s3" class="slide mask">
      ...
      <div style="display: flex; justify-content: center">
        <div class="profile">
          ...
          <input
            style="margin: 2vh; height: 5vmin; width: 10vmin"
            type="button"
            value="個人頁面"
            onclick="window.open('https://kotno557.github.io/Internet-fall-2022/')"
          />
        </div>
        <div class="profile">
          <img
          ...
          <input
            ...
            type="button"
            value="個人頁面"
            onclick="window.open('https://internet.nizw0.com/')"
          />
        </div>
      </div>
    </div>
    <div id="b1" class="bar show">
      ...
      <div id="login">
        <div>請輸入房間#ID</div>
        <div>
          <input id="room-id" type="text" /><br /><input
            @click="jump_room()"
            type="button"
            value="Go!"
          />
